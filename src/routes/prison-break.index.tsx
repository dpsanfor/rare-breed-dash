      ...
      >
        ...
        {allComplete ? (
          ...
          <>
            ...
            <p className="max-w-xl font-serif text-xl italic leading-relaxed text-[#4A1259]/75 mb-6">
              Good Girl Prison Break hands you your Zone of Genius Code™. The 10X Leap is the design tool that turns it into your complete business: eleven elements, one 10X Factor Operating Manual™. And Dana is beside you on three live calls while you build.
            </p>
          </>
        )}
