    ...
    >
      ...
      <div className="flex-1 space-y-4 mb-8">
        <p className="font-serif text-[17px] leading-relaxed text-[#1F1623]">
          Five AI-guided design phases that transform your Zone of Genius into a complete business blueprint — your 10X Factor Operating Manual™.
        </p>
        <p className="font-serif text-[17px] leading-relaxed text-[#1F1623]">
        ...
        <div className="grid grid-cols-1 gap-4 items-stretch lg:grid-cols-3">
          ...
          {access?.phase2 ? (
            <PhaseCard
              phaseNum="02 · Design"
              name="The 10X Leap™"
              descriptor="Create the life and business that naturally emerge from your Zone of Genius. Every exercise becomes structured intelligence stored in your 10X Factor Operating Manual™."
          ...
          {access?.phase3 ? (
            <FeaturedCard
              descriptor="Install your 10X Factor Operating Manual™ into Rare Breed OS™. Every Studio already knows who you are—and uses that intelligence to generate your messaging, offers, content, emails, launches, curriculum, brand, and business systems."
            ...
            <FeaturedCard
              descriptor="Your 10X Factor Operating Manual™ plugs into twelve AI Studios that already know who you are — generating your messaging, offers, sales pages, content, launches, and brand from one source."
