...
const DELIVERABLES = [
  ...
  "Your 1010X Factor Operating Manual™",
];
  ...
  return (
    <BrandShell hideStickyCta>
      <div className="mx-auto max-w-2xl py-16">
        ...
        <p className="font-serif text-[22px] leading-relaxed text-[#4A1259]/70 mb-10 max-w-xl">
          3 months of done-with-you business building — 1:1 with Dana — using Rare Breed OS™ with all 9 Studios powered by your 1010X Factor Operating Manual™ and Zone of Genius Code™. Your most complete, most aligned business, built out as fast as possible. Most clients are done in 2 weeks. You have up to 3 months.
        </p>
