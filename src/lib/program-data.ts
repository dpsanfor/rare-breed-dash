    ...
    modules: [
      {
        ...
        tagline: "The exact woman your business exists to serve — in her own language.",
        purpose:
          "This Builder extracts the identity, psychology, buying triggers, emotional language, behavior patterns, and transformation desires of your dream client. Not demographics. Not pain points. The complete portrait of the woman who is ready to become who you know she can be. Built from your Operating Manual so the AI already knows your zone of genius and category — it only asks what's missing.",
        type: "conversation",
      ...
      },
      {
        ...
        purpose:
          "Messaging that emerges from your Operating Manual and Dream Client Playbook — not from copywriting formulas. Core messaging, brand guide, messaging pillars, website copy, bio, positioning statement.",
        type: "conversation",
      ...
      },
      {
        ...
        purpose:
          "Not isolated offers — an offer journey. Built from your Magic Gumdrop, Zone of Genius, and Dream Client. Priced from Wanted Money. Sequenced for ascension.",
        type: "conversation",
      ...
      },
      {
        ...
        purpose:
          "Not information organized into modules. Frameworks, lessons, milestones, exercises, and transformations extracted from your lived teaching and zone of genius.",
        type: "conversation",
      ...
      },
      {
        ...
        purpose:
          "Sales page copy that doesn't sound like everyone else's — because it comes from your Operating Manual, your Dream Client, your Messaging, and your Offer.",
        type: "conversation",
      ...
      },
      {
        ...
        purpose:
          "Brand playbook, visual direction, photography brief, brand experience, and brand personality — all derived from your Category of One and Operating Manual.",
        type: "conversation",
      ...
      },
      {
        ...
        purpose:
          "Launch playbook, sequencing, messaging calendar, content plan — all derived from your offer, your dream client, your messaging. No generic launch templates.",
        type: "conversation",
      ...
      },
      {
        ...
        purpose:
          "The final synthesis. Every Playbook from every Builder, combined with your Operating Manual, into one complete Rare Breed Business Playbook™. Identity, business, marketing, brand, and growth — unified.",
        type: "synthesis",
