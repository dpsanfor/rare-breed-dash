  ...
  },
  {
    ...
    modules: [
      ...
      },
      {
        ...
        feedsInto: "Element 11 synthesizes every decision you've made into your 10X Factor Operating Manual™ — the complete design of your business, ready to build from.",
      },
      {
        id: "operating-manual",
        number: 11,
        name: "10X Factor Operating Manual™",
        tagline: "Every decision synthesized into one document. You walk away with your 10X Factor Operating Manual™: the complete design of your business, ready to plug into the Club.",
        purpose:
          "Bring everything you've created together into one living blueprint — your 10X Factor Operating Manual™. This becomes the intelligence Rare Breed OS™ uses to generate your messaging, offers, content, launches, and business when you activate it inside Delivered. So that you only have to think deeply once. After that, Rare Breed OS™ brings your business to life from your unique genius — not a blank page.",
        type: "synthesis",
