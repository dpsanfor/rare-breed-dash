    ...
    modules: [
      {
        ...
        feedsInto: "Your 10X Vision becomes the north star Module 2 uses to build your 10X Release Plan — identifying everything that has to go to make room for the business you just claimed.",
      },
      {
        id: "release-80",
        number: 2,
        ...
        nextDecision: "What am I releasing this week. Not eventually.",
        feedsInto: "With the dead weight cleared, Module 3 builds the operating system you'll make every future decision from: your 10X Constitution™.",
      },
      {
        id: "constitution",
        number: 3,
        name: "10X Constitution™",
        tagline: "The AI interviews you like Dana would and extracts your principles, standards, and decision filters. You walk away with your 10X Constitution™: the decision filter that makes every hard business call obvious, so you stop second-guessing yourself and run the whole business on your standards instead of everyone else's.",
        purpose:
          "This is the interview. The AI interviews you exactly like Dana Hayes, reflecting patterns, challenging comfort, digging beneath surface answers. So that you leave with your 10X Constitution: a clear, documented operating system you can make decisions from. Starting immediately.",
        type: "context",
        outputName: "10X Constitution™",
        outputKey: "constitution",
        nextDecision: "Am I making decisions from my old OS or my new one?",
        feedsInto: "Your 10X Constitution is the identity your genius grows from. Module 4 uses it to define your 10X Zone of Genius: the work only you can own.",
      },
      {
        id: "zone-of-genius",
        number: 4,
        name: "10X Zone of Genius",
        tagline: "The work only you can own, decided once at full depth. You walk away with your 10X Zone of Genius Report.",
        purpose:
      ...
      },
      {
        ...
        feedsInto: "Module 6 captures your real evidence and walking testimony: the proof that makes your dream client believe the transformation is possible for her.",
      },
      {
        id: "living-proof",
        number: 6,
        name: "10X Living Proof",
        tagline: "See that your lived experience IS the credential, then capture the evidence that makes your offers worth premium money. You walk away with your 10X Living Proof.",
        purpose:
        ...
        generatePrompt:
          "I'm ready. Generate my 10X Living Proof based on everything we've discussed.",
      ...
      },
      {
        ...
        feedsInto: "With the container built, Module 8 decides exactly who the business serves: your 10X Dream Client.",
      },
      {
        id: "dream-client-decision",
        number: 8,
        name: "10X Dream Client",
        tagline: "The one woman this business exists to serve, decided once. You walk away with your 10X Dream Client, the page every Club asset gets written to.",
        purpose:
        ...
        feedsInto: "Module 9 maps the offers she ascends through: your flagship and the ascension logic that connects them.",
      },
      {
        id: "offer-map",
        number: 9,
        name: "10X Offer Map",
        tagline: "Your flagship and your offer path: names, promises, prices, capacity-checked. You walk away with your 10X Offer Map.",
        purpose:
          "The shape, not the copy (the Club's Studios build every offer out completely). Your flagship gets built from your Zone of Genius, priced from Wanted Money, and checked against your 10X Calendar's capacity number. Your entry-point offers lead your dream client to it. And the ascension logic makes upgrading structural: each step hands her the exact thing the next step requires.",
        type: "conversation",
        outputName: "10X Offer Map",
        outputKey: "offer_map",
        ...
        mission: [
          ...
          "the entry-point and ascension offers that lead your dream client to the flagship",
        ...
        generatePrompt:
          "I'm ready. Generate my 10X Offer Map based on everything we've discussed.",
      ...
      },
      {
        ...
        tagline: "The three things no AI can invent: your name, your taste, and your voice. You walk away with your 10X Brand Direction, used by every Studio that writes as you.",
        purpose:
        ...
        feedsInto: "Module 11 synthesizes every decision you've made into your X Factor Operating Manual™ — the complete design of your business, ready to generate everything.",
      },
      {
        id: "operating-manual",
        number: 11,
